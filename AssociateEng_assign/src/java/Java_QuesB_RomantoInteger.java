...
public class Java_QuesB_RomantoInteger
{   
  int value(char r)   
  {   
    if (r == 'I')   
...
//returns corresponding integer value  
  ...
  {   
    ...
    Java_QuesB_RomantoInteger ob = new Java_QuesB_RomantoInteger();  
    System.out.println("enter a roman no");
    String romanStr= d.readLine();
    System.out.println("The integer value of roman no is: "+ob.converttoint(romanStr));   
  }   
}  