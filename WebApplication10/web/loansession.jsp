<%-- 
    Document   : newjsp1
    Created on : 15 Oct, 2023, 12:58:19 PM
    Author     : DELL-PC
--%>
...
<html>
    ...
    <body>
       ...
       <%="COUNTRY IS"%>       <%=ab12%></br>
        ...
        <%="The Confirm reason of loan IS"%>      <%=ab15%></br>
      
        <%="DATE OF BIRTH IS"%>      <%=ab16%></br>
        <%="The employee sign is"%>      <%=ab17%></br>
        
<!--        <form action="NewServlet1">
            <input type="submit" name="action" value="Edit"  style="color:white;background-color:blue" ><br>
            <input type="submit" name="action" value="submit application for loan" style="color:white;background-color:green" >
...
//response.sendRedirect("NewServlet1");
            ...
            <input type="submit" name="action" value="Submit" id="send loan request" style="color:white;background-color:green" >
            </form>
